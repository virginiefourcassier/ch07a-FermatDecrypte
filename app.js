...
(() => {
  ...
  const R = { Ag:16, S:15, Al:16, O:10, H:7 };
  ...
  function reactionProbability(){
    ...
    const base = 0.018; // tuned for "arrive vite"
    const tFactor = (0.8 + 0.35*T); // T=1..5
